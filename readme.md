...
Ten unbeatable reasons to use this extension:
1. Uses Jadeship's Universal Link Converter, the most popular & battle-proven link converter
2. Decrypt shortened links - the only extension able to do so
3. No affiliate link hijacking - clean links, no referral codes
4. Most agents to choose from (30+)
5. Clean toolbar - automatically hidden and customizable
6. QC pic feature - checks for available QC pics
7. Over-the-air updates (effortless for us, you get updates more frequently)
8. "Featured" by the Chrome Web Store, an award for adhering to code best practices (the only extension)
9. The oldest extension - copied many times
10. Open source - no malware, not infected with affiliate links
...
- no affiliate link hijacking - links generated by this extension do not contain affiliate links
- on a registration page, a dialog may appear that asks if you want to signup with Jadeship. This is transparent, specific to single page, unintrusive, in your control and can be permanently disabled from the settings.
